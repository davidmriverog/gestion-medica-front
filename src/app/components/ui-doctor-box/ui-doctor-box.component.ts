...
@Component({
  selector: 'ui-doctor-box',
  templateUrl: './ui-doctor-box.component.html',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => UIDoctorBoxComponent),
      multi: true
    }
  ],
  encapsulation: ViewEncapsulation.None
})
export class UIDoctorBoxComponent implements OnInit, OnDestroy, ControlValueAccessor {
  ...
  @Output()
  onDoctorClear: EventEmitter<any> = new EventEmitter();
  ...
  search(event: { query: string }): void {
    ...
    this.filteredResult$ = this.doctorService.searching(event.query.toLocaleLowerCase());
  }
  ...
  populatedModalSelection(row: DoctorModel): void {
    this.isSeleted = true;
